{{-- resources/views/pages/products/damla.blade.php --}}
@extends('layouts.app')

@section('title', 'Damla Mikrofon Süngeri | Bi Mikrofon Süngeri')
@section('content')
    @php
        use Jenssegers\Agent\Agent;
        // SEO uyumlu dosya adlarıyla 6 adet Damla Mikrofon Süngeri
        $images = [];
        for ($i = 1; $i <= 6; $i++) {
            $images[] = [
                'src' => "/products/damla/damla-mikrofon-sungeri-{$i}.png",
                'hover' => "/second/damla/damla-mikrofon-sungeri-{$i}.png",
                'alt' => 'Damla Mikrofon Süngeri',
            ];
        }
            ...
            <section
                ...
                <div class="space-y-7 lg:p-8 w-full">
                    <h2 class="text-black text-2xl sm:text-3xl font-semibold pt-3">
                        Damla Mikrofon Süngeri Baskı
                    </h2>

                    <p class="text-black text-sm sm:text-base font-normal max-w-xl leading-6">
                        Logonuzla özelleştirilmiş damla mikrofon süngerleriyle yayınlarınızı, tanıtımlarınızı ve sosyal
                        medya içeriklerinizi profesyonel hale getirin. Hızlı üretim, uygun fiyat ve 6 farklı renk
                        seçeneğiyle hizmetinizdeyiz.
                    </p>

                    <x-product-dimensions width="6.5 cm" height="10 cm" depth="3.5 cm" />
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-start">
                            ...
                            <div class="text-xs sm:text-sm text-yellow-800">
                                <strong>Özel Avantaj:</strong> Damla tasarımı dış mekan kayıtlarında rüzgar sesini minimize
                                eder ve estetik görünüm sağlar.
                            </div>
                        </div>
                    </div>
                </div>

                <img src="/products/damla/damla-mikrofon-sungeri-5.png"
                    alt="Logo baskılı damla mikrofon süngeri - özelleştirilmiş sünger modelleri"
    ...
    <style>
        ...
        /* Teardrop shape for buttons */
        button[style*="border-radius: 50% 50% 50% 0"] {
            transform-origin: center;
        }

        button[style*="border-radius: 50% 50% 50% 0"]:hover {
