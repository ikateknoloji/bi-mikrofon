{{-- resources/views/pages/products/top.blade.php --}}
@extends('layouts.app')

@section('title', 'Top Mikrofon Süngeri | Bi Mikrofon Süngeri')
@section('content')
    @php
        use Jenssegers\Agent\Agent;
        // SEO uyumlu dosya adlarıyla 6 adet Top Mikrofon Süngeri
        $images = [];
        for ($i = 1; $i <= 6; $i++) {
            $images[] = [
                'src' => "/products/top/top-mikrofon-sungeri-{$i}.png",
                'hover' => "/second/top/top-mikrofon-sungeri-{$i}.png",
                'alt' => 'Top Mikrofon Süngeri',
            ];
        }
            ...
            <section
                ...
                <div class="space-y-7 lg:p-8 w-full">
                    <h2 class="text-black text-2xl sm:text-3xl font-semibold pt-3">
                        Top Mikrofon Süngeri Baskı
                    </h2>

                    <p class="text-black text-sm sm:text-base font-normal max-w-xl leading-6">
                        Logonuzla özelleştirilmiş top mikrofon süngerleriyle yayınlarınızı, tanıtımlarınızı ve sosyal medya
                        içeriklerinizi profesyonel hale getirin. Hızlı üretim, uygun fiyat ve 6 farklı renk seçeneğiyle
                        hizmetinizdeyiz.
                    </p>

                    <x-product-dimensions width="5.5 cm" height="9 cm" depth="3.5 cm" />
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-start">
                            ...
                            <div class="text-xs sm:text-sm text-yellow-800">
                                <strong>Not:</strong> Top mikrofon süngerleri hafif yapısı ile taşınabilir kayıtlar için
                                idealdir. 360° logo görünürlüğü sağlar.
                            </div>
                        </div>
                    </div>
                </div>

                <img src="/products/top/top-mikrofon-sungeri-3.png"
                    alt="Logo baskılı top mikrofon süngeri - özelleştirilmiş sünger modelleri"
    ...
    <style>
        ...
        /* Perfect circle for ball-shaped product */
        .rounded-full {
