...
@section('title', 'Silindir Mikrofon Süngeri | Bi Mikrofon Süngeri')
@section('content')
    @php
        use Jenssegers\Agent\Agent;

        // SEO uyumlu dosya adlarıyla 12 adet Silindir Mikrofon Süngeri
        $images = [];
        for ($i = 1; $i <= 12; $i++) {
            $images[] = [
                'src' => "/products/silindir/silindir-mikrofon-sungeri-{$i}.jpg",
                'hover' => "/second/silindir/silindir-mikrofon-sungeri-{$i}.jpg",
                'alt' => 'Silindir Mikrofon Süngeri',
            ];
        }
            ...
            <section
                ...
                <div class="space-y-7 lg:p-8 w-full">
                    <h2 class="text-black text-2xl sm:text-3xl font-semibold pt-3">
                        Silindir Mikrofon Süngeri Baskı
                    </h2>

                    <p class="text-black text-sm sm:text-base font-normal max-w-xl leading-6">
                        Logonuzla kişiselleştirilmiş silindir mikrofon süngerleriyle markanızı ön plana çıkarın.
                        Yayınlarınızda, röportajlarda ve sosyal medya içeriklerinizde profesyonel bir görünüm kazanın. Hızlı
                        üretim, uygun fiyat ve 12 farklı renk seçeneğiyle hizmetinizdeyiz.
                    </p>

                    <x-product-dimensions width="7.5 cm" height="12 cm" depth="4.5 cm" />
                ...
                <img src="/products/silindir/silindir-mikrofon-sungeri-5.jpg"
                    alt="Logo baskılı mikrofon süngeri - özelleştirilmiş sünger modelleri"
