{{-- resources/views/pages/products/ucgen.blade.php --}}

@extends('layouts.app')

@section('title', 'Üçgen Mikrofon Süngeri | Bi Mikrofon Süngeri')

@section('content')

    @php
        use Jenssegers\Agent\Agent;
        // SEO uyumlu dosya adlarıyla 12 adet Üçgen Mikrofon Süngeri
        $images = [];
        for ($i = 1; $i <= 12; $i++) {
            $images[] = [
                'src' => "/products/ucgen/ucgen-mikrofon-sungeri-{$i}.jpg",
                'hover' => "/second/ucgen/ucgen-mikrofon-sungeri-{$i}.jpg",
                'alt' => 'Üçgen Mikrofon Süngeri',
            ];
        }
    ...
    <div x-data="{
        ...
        <x-product.left-content class="space-y-4 p-4">
            ...
            <section
                class="col-span-1 md:col-span-3 lg:mx-16 relative flex md:flex-row flex-col-reverse
                       font-outfit text-[#121990] bg-contain bg-center rounded-md overflow-hidden"
                ...
                <div class="space-y-7 lg:p-8 w-full">
                    <h2 class="text-black text-2xl sm:text-3xl font-semibold pt-3">
                        Üçgen Mikrofon Süngeri Baskı
                    </h2>

                    <p class="text-black text-sm sm:text-base font-normal max-w-xl leading-6">
                        Logonuzla özelleştirilmiş üçgen mikrofon süngerleriyle yayınlarınızı, tanıtımlarınızı ve sosyal
                        medya içeriklerinizi profesyonel hale getirin. Hızlı üretim, uygun fiyat ve 12 farklı renk
                        seçeneğiyle hizmetinizdeyiz.
                    </p>


                    <x-product-dimensions width="6.5 cm" height="11 cm" depth="4.5 cm" />
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-yellow-800">
                                <strong>Not:</strong> Tüm renkler logo baskısı için uygundur. Özel renk talepleriniz için
                ...
                <img src="/products/ucgen/ucgen-mikrofon-sungeri-7.jpg"
                    alt="Logo baskılı üçgen mikrofon süngeri - özelleştirilmiş sünger modelleri"
