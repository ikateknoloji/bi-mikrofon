...
@section('title', 'Kare Mikrofon Süngeri | Bi Mikrofon Süngeri')
@section('content')
    @php
        use Jenssegers\Agent\Agent;
        // SEO uyumlu dosya adlarıyla 12 adet Kare Mikrofon Süngeri
        $images = [];
        for ($i = 1; $i <= 12; $i++) {
            $images[] = [
                'src' => "/products/kare/kare-mikrofon-sungeri-{$i}.jpg",
                'hover' => "/second/kare/kare-mikrofon-sungeri-{$i}.jpg",
                'alt' => 'Kare Mikrofon Süngeri',
            ];
        }
            ...
            <section
                ...
                <div class="space-y-7 lg:p-8 w-full">
                    <h2 class="text-black text-2xl sm:text-3xl font-semibold pt-3">
                        Kare Mikrofon Süngeri Baskı
                    </h2>

                    <p class="text-black text-sm sm:text-base font-normal max-w-xl leading-6">
                        Logonuzla kişiselleştirilmiş kare mikrofon süngerleriyle markanızı ön plana çıkarın. Röportajlar,
                        canlı yayınlar ve sosyal medya videolarınızda dikkat çekici bir görünüm elde edin. Hızlı üretim,
                        uygun fiyat ve 12 farklı renk seçeneğiyle yanınızdayız.
                    </p>

                    <x-product-dimensions width="6 cm" height="11 cm" depth="4.5 cm" />
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                        <div class="flex items-start">
                            ...
                            <div class="text-xs sm:text-sm text-yellow-800">
                                <strong>Not:</strong> Kare mikrofon süngerleri özellikle röportaj ve stüdyo kayıtları için
                                idealdir. Tüm renkler logo baskısı için uygundur.
                            </div>
                        </div>
                    </div>
                </div>

                <img src="/products/kare/kare-mikrofon-sungeri-12.jpg"
                    alt="Logo baskılı kare mikrofon süngeri - özelleştirilmiş sünger modelleri"
    ...
    <style>
        ...
        /* Square shape for color buttons to match product */
        .rounded-lg {
