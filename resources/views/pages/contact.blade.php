...
@section('title', 'İletişim | Mikrofon Süngeri Baskı')
@section('content')
    <!-- Main Content -->
    <div class="bg-gray-50 min-h-screen mt-16 lg:mt-0  mb-20 lg:mb-0 ">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div class="bg-white p-6 sm:p-8 border border-gray-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <!-- Main Content Grid -->
                    <div class="col-span-3 grid lg:grid-cols-3 gap-12">
                        <!-- Ana Sayfalar -->
                        ...
                        <!-- Mikrofon Süngeri Kategorileri -->
                        <div>
                            <h2 class="text-2xl font-medium text-black mb-8 pb-3 border-b border-gray-300">Mikrofon Süngeri
                                Kategorileri</h2>
                            <div class="space-y-4">
                                <div class="group">
                                    <a href="{{ route('silindir') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">
                                            Silindir
                                            Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Klasik silindir form baskı</p>
                                    </a>
                                </div>
                                <div class="group">
                                    <a href="{{ route('kare') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">
                                            Kare Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Modern kare tasarım baskı</p>
                                    </a>
                                </div>
                                <div class="group">
                                    <a href="{{ route('ucgen') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">Üçgen
                                            Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Dinamik üçgen form baskı</p>
                                    </a>
                                </div>
                                <div class="group">
                                    <a href="{{ route('top') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">Top
                                            Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Yuvarlak top form baskı</p>
                                    </a>
                                </div>
                                <div class="group">
                                    <a href="{{ route('damla') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">Damla
                                            Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Şık damla form baskı</p>
                                    </a>
                                </div>
                                <div class="group">
                                    <a href="{{ route('reklam-kupu') }}"
                                        class="block bg-white p-5 border border-gray-200 hover:border-black transition-all duration-300">
                                        <h3 class="text-base font-medium text-black mb-1 group-hover:text-gray-600">Reklam
                                            Küpü
                                            Mikrofon Süngeri</h3>
                                        <p class="text-gray-500 text-xs">Özel reklam küpü baskı</p>
                                    </a>
                                </div>
                            </div>
                        </div>
